...
- ACTION: Nick- make channel in the slack for us to discuss the Study Festival (done)
- ACTION: Nick - follow through with shirt orders (done)
- ACTION: Dadams - investigate for after study break (done)
- ACTION: Nick - make channel to discuss charity vigil prizes (done)
